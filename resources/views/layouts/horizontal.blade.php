                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <a href="ui-session-timeout" class="dropdown-item">Session
                                                    Timeout</a>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-vertical">
                                                    <a href="layouts-compact-sidebar" class="dropdown-item">Compact
                                                        Sidebar</a>
                                                    <a href="layouts-icon-sidebar" class="dropdown-item">Icon
                                                        Sidebar</a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-horizontal">
                                                    ...
                                                    <a href="layouts-hori-topbarlight" class="dropdown-item">Topbar
                                                        Light</a>
                                                    <a href="layouts-hori-boxed" class="dropdown-item">Boxed
                                                        Layout</a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <a href="pages-recoverpw" class="dropdown-item">Recover
                                                    Password</a>
            ...
            <div class="dropdown d-none d-sm-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('build/images/flags/spain.jpg') }}" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('build/images/flags/germany.jpg') }}" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('build/images/flags/italy.jpg') }}" alt="user-image" class="me-1" height="12"> <span
                            class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('build/images/flags/russia.jpg') }}" alt="user-image" class="me-1" height="12"> <span
